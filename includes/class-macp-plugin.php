...
class MACP_Plugin {
    ...
    // Initialize AJAX handlers - moved after all required files are loaded
...
public function deactivate() {
    // Add these lines to remove CSS exclusion settings
    delete_option('macp_css_safelist');
    delete_option('macp_css_excluded_patterns');
